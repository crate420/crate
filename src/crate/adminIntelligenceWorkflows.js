...
function reviewRowFromArtistIntelligence(row, recommendation, stats) {
  ...
  return {
    ...
    playlist_intelligence_collections: recommendation.playlist_intelligence_collections || [],
    playlist_intelligence_consensus_count: recommendation.playlist_intelligence_consensus_count || 0,
    playlist_intelligence_supporting_tracks: recommendation.playlist_intelligence_supporting_tracks || 0,
    last_updated: recommendation.last_updated || null,
